            ...
            <div key={si}>
              ...
              <div style={{ overflowX: "auto" }}>
                <div style={{ minWidth: 480, border: "1px solid #e6e0d2", borderRadius: 2, overflow: "hidden" }}>
                  <div style={{ display: "grid", gridTemplateColumns: "minmax(280px,2.4fr) 90px minmax(150px,1fr)", background: COAL, color: "#fff", fontSize: 11, fontWeight: 800, textTransform: "uppercase" }}>
                  ...
                  {sec.items.map((it, ii) => {
                    ...
                    return (
                      <div key={ii} style={{ display: "grid", gridTemplateColumns: "minmax(280px,2.4fr) 90px minmax(150px,1fr)", fontSize: 14, borderTop: "1px solid #eae4d6" }}>
