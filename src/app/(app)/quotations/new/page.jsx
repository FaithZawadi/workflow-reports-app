...
import { isClient, canPrepareQuotes, rolesOf, canRaiseOwnQuotes } from "@/lib/roles";
...
export default async function NewQuotationPage({ searchParams }) {
  ...
  const allowed = isClient(claims) || canPrepareQuotes(claims) || rolesOf(claims).includes("ADMIN") || canRaiseOwnQuotes(claims);
